...
import sys
sys.path.append('/mnt/CLOPS/Experimental Networks/')
...
class PrimaryNetwork(nn.Module):
    ...
    def __init__(self,dropout_type,p1,p2,p3,dataset_name,stride=3,hyperattention_type='nonlocal',bptt_steps=0,heads='single', setting=None, trial=None):
    ...
    def forward(self,x,bptt_counter=None):
        ...
        for i,(original_module,attention_module,hidden_attention_time,conv_module) in enumerate(zip(self.original_modules,self.attention_modules,self.hidden_attentions_time,self.conv_modules)):
            ...
            for j,param in enumerate(original_module.parameters()):
                ...
                if self.bptt_steps is not None and bptt_counter is not None:
